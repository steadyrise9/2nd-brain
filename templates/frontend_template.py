...
Frontend authoring flow:
  ...
  5. Call register_plugin(plugin_type="frontend", file_name="frontend_<your_name>.py").
  ...
  9. To remove live only: unregister_plugin(plugin_type="frontend", plugin_name="<frontend name>").
