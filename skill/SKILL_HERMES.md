...
metadata:
  hermes:
    tags: [search, knowledge-base, files]
    category: productivity
    config:
      - key: second_brain.url
        description: "Base URL of the running Second Brain instance"
        default: "http://localhost:5123"
        prompt: "Second Brain URL"
required_environment_variables:
  - name: SECOND_BRAIN_URL
    prompt: Second Brain base URL
    help: "Base URL of the running instance (e.g. http://192.168.1.50:5123)"
    required_for: full functionality
  - name: SECOND_BRAIN_TOKEN
    prompt: Second Brain bearer token
    help: "Optional auth token. Leave blank if unauthenticated."
    required_for: authenticated access
---
