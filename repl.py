...
from gui.formatters import (
    ...
    format_stats, format_tools, format_help,
)
...
def run_repl(ctrl, shutdown_fn, shutdown_event: threading.Event,
    ...
    def cmd_tasks(arg):
        print(format_tasks(ctrl.list_tasks()))
    ...
    def cmd_stats(arg):
        print(format_stats(ctrl.stats()))

    def cmd_tools(arg):
        print(format_tools(ctrl.list_tools()))
    ...
    def cmd_call(arg):
        ...
        print(format_tool_result(ctrl.call_tool(tool_name, kwargs)))
