...
def test_kernel_defaults_are_minimal():
    ...
    assert config_manager.DEFAULTS["autoload_services"] == ["llm", "compactor", "parser", "plugin_watcher", "plan_mode"]
...
def test_load_creates_default_config_when_missing(tmp_path):
    ...
    assert on_disk["autoload_services"] == ["llm", "compactor", "parser", "plugin_watcher", "plan_mode"]
