...
def _architecture() -> str:
    return (
        ...
        "query the database or call other tools, and return structured results. Your available tools are provided via function calling. The tool call limit is per-message, not per-session.\n"
        "\n"
